...
shaka.dash.DashParser = class {
  ...
  async processManifest_(mpd, finalManifestUri) {
    ...
    console.log(`MS: presentationStartTime = ${presentationTimeline.presentationStartTime_*1000}, ` +
                                      `${new Date(presentationTimeline.presentationStartTime_*1000)}`);
  ...
  async onUpdate_() {
    ...
    // shaka.log.info('MS3: Updating manifest...');
    ...
    // shaka.log.info(`MS3: Updating manifest - update delay = ${updateDelay}`);
